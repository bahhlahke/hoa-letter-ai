    ...
    <main className="container">
      <div className="card" style={{ padding: 22, maxWidth: 760, margin: "40px auto" }}>
        <div className="pill" style={{ marginBottom: 10 }}>
          <span>Stripe</span><span style={{ opacity: 0.7 }}>•</span><span>Checkout</span>
        </div>
        ...
        {status === "paid" && (
          <>
            ...
            <p className="muted">Unlocked{mode === "subscription" ? " (subscription)" : ""}. Redirecting…</p>
        ...
        {status === "unpaid" && (
          <>
            ...
            <p className="muted">You can try again.</p>
            <a className="button" href="/" style={{ display: "inline-block", textDecoration: "none" }}>Return home</a>
          </>
        )}
        {status === "error" && (
          <>
            <h2 style={{ marginTop: 14, fontSize: 22 }}>Something went wrong</h2>
            <p className="muted">Return home and try again.</p>
            <a className="button" href="/" style={{ display: "inline-block", textDecoration: "none" }}>Return home</a>
          </>
        )}
      </div>
